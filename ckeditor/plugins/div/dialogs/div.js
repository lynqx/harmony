        ...
        return{title: a.lang.div.title, minWidth: 400, minHeight: 165, contents: [
            {id: "info", label: a.lang.common.generalTab, title: a.lang.common.generalTab, elements: [
                {type: "hbox", widths: ["50%", "50%"], children: [
                    {id: "elementStyle", type: "select", style: "width: 100%;", label: a.lang.div.styleSelectLabel, "default": "", items: [
                        ...
                        this.commit(h, !0);
                        for (var d = [].concat(d), b = d.length, i, e = 0; e < b; e++)(i = c.getContentElement.apply(c, d[e].split(":"))) && i.setup && i.setup(h, !0)
                    }, setup: function (a) {
                    ...
                    {id: "class", type: "text", label: a.lang.common.cssClass,
                        "default": ""}
                ]}
            ]},
            {id: "advanced", label: a.lang.common.advancedTab, title: a.lang.common.advancedTab, elements: [
                {type: "vbox", padding: 1, children: [
                    ...
                    {type: "hbox", children: [
                        {type: "text",
                            id: "title", style: "width: 100%;", label: a.lang.common.advisoryTitle, "default": ""}
                    ]},
            ...
            a.getStylesSet(function (a) {
                ...
                if (a)for (var i = 0; i < a.length; i++) {
                    var e = a[i];
                    e.element && "div" == e.element && (b = e.name, l[b] = new CKEDITOR.style(e),
            ...
            if ("editdiv" == k)m = [this._element]; else {
                var d = [], c = {}, h = [], b, i = a.getSelection(), e = i.getRanges(), l = i.createBookmarks(), g, j;
                for (g = 0; g < e.length; g++)for (j = e[g].createIterator(); b = j.getNextParagraph();)if (b.getName()in n) {
                    var f = b.getChildren();
                    for (b = 0; b <
                        f.count(); b++)p(h, f.getItem(b), c)
                } else {
                ...
                e = [];
                g = null;
                for (j = 0; j < h.length; j++)b = h[j], f = a.elementPath(b).blockLimit, a.config.div_wrapTable && f.is(["td", "th"]) && (f = a.elementPath(f.getParent()).blockLimit), f.equals(g) || (g = f, e.push([])), e[e.length - 1].push(b);
                for (g = 0; g < e.length; g++) {
                    ...
                    for (b = 0; b < e[g].length; b++)if (f = e[g][b], !f.getCustomData || !f.getCustomData("block_processed"))f.is && CKEDITOR.dom.element.setMarker(c, f, "block_processed", !0), b || j.insertBefore(f), j.append(f);
                    CKEDITOR.dom.element.clearAllMarkers(c);
                    d.push(j)
                }
                i.selectBookmarks(l);
            ...
            "editdiv" ==
                k && this._element.removeCustomData("elementStyle");
