...
<form action="<?php echo base_url() ?>userview/update" method="post"
...
<div class="control-group">
    <div class="controls">
        <div class="input-prepend">
            ...
            <input id="prependedInput" type="text" name="addressline1" placeholder="Address Line 1" value="<?php echo $home_address; ?>"/>
        </div>
    </div>
</div>
<div class="control-group">
    <div class="controls">
        <div class="input-prepend">
            ...
            <input id="prependedInput" type="text" name="addressline2" placeholder="Address Line 2" value="<?php echo $home_town; ?>" />
        </div>
    </div>
</div>
