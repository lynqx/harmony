...
?>
<div class="navbar">
    <div class="navbar-inner"><h6>Messages Inbox</h6></div>
</div>
<?php
    $data = $this->session->flashdata('delete');
    if (isset($data)) echo '<span class="alert alert-block alert-info">'.$data.'</span>';
    ?>
    <div class="table-overflow">
        <table class="table table-striped table-bordered" id="data-table">
            ...
            $messages = modules::run('message/fetchMessages', $user, 'inbox');
            //print_r($messages);
            $count = 1;
