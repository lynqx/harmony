...
INSERT INTO `contributions_rules` (`id`, `contribution_id`, `rule_title`, `category_code`) VALUES
	(2, 1, 'loan_user_balance_greater_than_amount', 'membership');
...
-- Dumping data for table armony.loans: ~1 rows (approximately)
DELETE FROM `loans`;
/*!40000 ALTER TABLE `loans` DISABLE KEYS */;
INSERT INTO `loans` (`id`, `name`, `description`, `date_created`) VALUES
	(1, 'Ijeta Loan scheme', 'This loan type is for bosses', '2014-07-25 21:42:15');
...
-- Dumping data for table armony.loans_rules: ~1 rows (approximately)
DELETE FROM `loans_rules`;
/*!40000 ALTER TABLE `loans_rules` DISABLE KEYS */;
INSERT INTO `loans_rules` (`id`, `rule_title`, `loan_id`, `date_created`) VALUES
	(1, 'loan_user_balance_greater_than_amount', 1, '2014-07-26 00:15:30');
...
INSERT INTO `loans_settings` (`id`, `loan_id`, `value`, `date_created`) VALUES
	(1, 1, '1:::5000', '2014-07-26 00:15:44');
...
-- Dumping data for table armony.rules: ~13 rows (approximately)
DELETE FROM `rules`;
/*!40000 ALTER TABLE `rules` DISABLE KEYS */;
INSERT INTO `rules` (`id`, `title`, `description`, `date_created`) VALUES
	(1, 'loan_user_balance_greater_than_amount', 'The User\'s balance is greater than the speculated amount', '2014-07-05 22:52:31'),
	(2, 'loan_user_must_belong_to_a_specific_group', 'The User must belong to a specific group', '2014-07-08 20:05:42'),
	(3, 'loan_user_min_balance_percent', 'The User\'s minimum balance per cent. The balance must be greater than this value', '2014-07-26 09:12:23'),
	(4, 'loan_deposit_amount', 'This is the expected deposit amount for loans once applied for', '2014-07-26 09:14:14'),
	(5, 'loan_deposit_percent', 'This is the expected deposit percentage', '2014-07-26 09:14:48'),
	(6, 'loan_repayment_duration', 'This is maximum duration period for a loan before complete repayment', '2014-07-26 09:16:18'),
	(7, 'loan_duration_repayment_percent', 'This is the percentage expected to be completely paid upon completion of the loan servicing', '2014-07-26 09:17:10'),
	(8, 'loan_minimum_number of guarantor', 'This is the minimum number of guarantors allowed for the loan', '2014-07-26 09:17:48'),
	(9, 'loan_max_guarantor_guarantee', 'How many people can the guarator guanrantee before disqualified', '2014-07-26 09:18:31'),
	(10, 'loan_can_be_set_off', 'Determines if the loan can be set off or overwritten', '2014-07-26 09:19:05'),
	(11, 'loan_need_witness', 'Determines if the loan needs witnesses', '2014-07-26 09:19:43'),
	(12, 'loan_start_month', 'The starting date for the loan in months', '2014-07-26 09:20:20'),
	(13, 'loan_end_month', 'The expected date for ending the loan', '2014-07-26 09:20:55');
...
INSERT INTO `rules_categories` (`id`, `rule_title`, `category_code`) VALUES
	(1, 'loan_user_balance_greater_than_amount', 'membership');
...
INSERT INTO `rule_definitions` (`id`, `rule_title`, `rules_def`, `require_settings`, `date_created`) VALUES
	(1, 'loan_user_balance_greater_than_amount', 'select getContributionBalance(?) > ? as vl', b'1', '2014-07-25 21:25:25'),
	(2, 'loan_user_must_belong_to_a_specific_group', 'select userInGroup(?,?) as vl', b'1', '2014-07-25 21:43:24');
...
-- Dumping structure for view armony.groups_view
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `groups_view` (
	`id` INT(11) NOT NULL,
	`name` VARCHAR(50) NULL COLLATE 'latin1_swedish_ci',
	`description` VARCHAR(500) NULL COLLATE 'latin1_swedish_ci',
...
-- Dumping structure for function armony.userInGroup
DELIMITER //
CREATE DEFINER=`root`@`localhost` FUNCTION `userInGroup`(`UserId` INT, `groupID` INT) RETURNS bit(1)
BEGIN
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` VIEW `groups_view` AS SELECT * from loans ;
